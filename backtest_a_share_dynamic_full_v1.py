...
from momentum_scanner_a_share_dynamic_v1 import calculate_factors_for_single_symbol  # 调用下层引擎
...
def calc_one(symbol: str) -> bool:
    ...
    try:
        ...
        # 构建因子计算所需的数据结构
        df_for_calc = df[['trade_date', 'close', 'total_mv', 'deduct_parent_netprofit', 'volume']].copy()
